...
public final class ConversationMoodAnalyzer {
   ...
   private static final List<String> COLLAB_WORDS = List.of(
      "давай", "вместе", "обсудим", "помоги", "как думаешь", "посоветуй", "разберем", "разберём", "let's", "together", "help me", "what do you think", "plan",     "vamos", "juntos", "discutir", "ayuda", "qué piensas", "planeemos", "hablemos", "opinión"

           );
   private static final List<String> APOLOGY_WORDS = List.of("прости", "извини", "сорри", "sorry", "my bad","lo siento", "perdón", "disculpa", "disculpe", "lo lamento", "sorry");
